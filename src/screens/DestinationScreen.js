...
import { View, Text, Image, TouchableOpacity, ScrollView, Animated, Easing, StatusBar, SafeAreaView, ImageBackground } from 'react-native';
      ...
      <View style={{ flex: 1, backgroundColor: theme.bgLight }}>
        ...
        <SafeAreaView style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', position: 'absolute', marginTop: ios ? 0 : hp(2) }}>
          <TouchableOpacity
            ...
            className="p-2 rounded-full ml-[20px] bg-white"
          ...
          <TouchableOpacity
            ...
            className="p-2 rounded-full mr-[20px] bg-gray-500"
            style={{ backgroundColor: 'rgba(255,255,255,0.5)' }}
          >
        ...
        <View style={{ borderTopLeftRadius: 40, borderTopRightRadius: 40 }} className="px-5 flex flex-1 justify-between pt-8 -mt-14">
          <ScrollView showsVerticalScrollIndicator={false} style={{ padding: wp(5), paddingTop: hp(0.1) }}>
            ...
            <Animatable.View animation="fadeInUpBig" delay={1200} style={{ marginTop: hp(0.1) }}>
              <TouchableOpacity className="bg-gray-500 h-[50px] w-[180px] mb-[8px] self-center justify-center items-center rounded-full">
                <Text className="text-black font-bold text-xl">Book now</Text>
              </TouchableOpacity>
            </Animatable.View>
          </ScrollView>
        </View>
